      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex justify-content-between align-items-center">
          <div>
            ...
            <?php if (!$isGuest): ?>
            <input type="text" class="form-control edit-mode d-none" name="name" value="<?= htmlspecialchars($name) ?>">
            <?php endif; ?>
          </div>
          <?php if (!$isGuest): ?>
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
          <div>
            ...
            <?php if (!$isGuest): ?>
            <input type="email" class="form-control edit-mode d-none" name="email" value="<?= htmlspecialchars($email) ?>">
            <?php endif; ?>
          </div>
          <?php if (!$isGuest): ?>
          <i class="bi bi-pencil-fill edit-icon toggle-edit"></i>
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
          <div>
            ...
            <?php if (!$isGuest): ?>
            <input type="text" class="form-control edit-mode d-none" name="phone" value="<?= htmlspecialchars($phone) ?>">
            <?php endif; ?>
          </div>
          <?php if (!$isGuest): ?>
          <i class="bi bi-pencil-fill edit-icon toggle-edit"></i>
