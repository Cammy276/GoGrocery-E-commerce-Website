                                ...
                                <ul class="item-list">
                                    ...
                                    <li>
                                        <div class="item-info">
                                            ...
                                            <div class="item-details">SKU: <?php echo htmlspecialchars($item['sku']); ?></div>
                                        ...
                                        <div class="item-price">RM <?php echo htmlspecialchars(number_format($item['unit_price'], 2)); ?>/unit</div>
                                        <div class="item-total">RM <?php echo htmlspecialchars(number_format($item['line_total'], 2)); ?></div>
                                    </li>
                                    <?php endforeach; ?>
