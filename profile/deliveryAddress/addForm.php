                ...
                <div class="content">
                    ...
                    <div class="settings-card">
                        <form method='post'>
                            ...
                            <input class="textInput" type='text' id='receiverName' name='receiverName' placeholder="e.g. Jacqueline"/>
                            <br/><br/>

                            <label>Address line 1:</label>
                            <input class="textInput" type='text' id='addLine1' name='addLine1' placeholder="e.g. Lot No. 241, Level 2 Menara,"/>
                            <br/><br/>

                            <label>Address line 2:</label>
                            <input class="textInput" type='text' id='addLine2' name='addLin2' placeholder="e.g. Petronas Twin Tower, Kuala Lumpur City Centre"/>
                            <br/><br/>

                            
                            <label>Postal Code:</label>
                            <input class="textInput" type='text' id='postalCode' name='postalCode' placeholder="e.g. 50088"/>
                            <br/><br/>
                            ...
                            <label>State:</label>
                            <input class="textInput" type='text' id='state' name='state' placeholder="e.g. Wilayah Persakutuan Kuala Lumpur"/>
                            <br/><br/>

                            <label>Country:</label>
                            <input class="textInput" type='text' id='country' name='country' placeholder="e.g. Malaysia" />
                            <br/><br/>
